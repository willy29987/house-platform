...
export const TAIWAN_REGIONS: TaiwanRegion[] = [
  ...
  {
    city: "高雄市",
    districts: ["楠梓區","左營區","鼓山區","三民區","鹽埕區","前金區","新興區","苓雅區","前鎮區","旗津區","小港區","鳳山區","大寮區","鳥松區","林園區","仁武區","大樹區","大社區","岡山區","路竹區","橋頭區","茄萣區","永安區","湖內區","彌陀區","阿蓮區","田寮區","燕巢區","旗山區","美濃區","六龜區","甲仙區","杉林區","內門區","茂林區","桃源區","那瑪夏區"],
  },
  {
    city: "基隆市",
  ...
  {
    city: "苗栗縣",
    districts: ["苗栗市","頭份市","竹南鎮","後龍鎮","通霄鎮","苑裡鎮","卓蘭鎮","造橋鄉","西湖鄉","頭屋鄉","公館鄉","銅鑼鄉","三義鄉","大湖鄉","獅潭鄉","泰安鄉","南庄鄉"],
  },
  {
    city: "彰化縣",
    districts: ["彰化市","員林市","和美鎮","鹿港鎮","溪湖鎮","二林鎮","田中鎮","北斗鎮","花壇鄉","芬園鄉","大村鄉","埔鹽鄉","埔心鄉","永靖鄉","社頭鄉","二水鄉","線西鄉","伸港鄉","福興鄉","秀水鄉","芳苑鄉","大城鄉","竹塘鄉","溪州鄉"],
  },
  {
    city: "南投縣",
